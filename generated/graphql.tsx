...
export type GetProductBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', name: string, price: number, id: string, images: Array<{ __typename?: 'Asset', id: string, url: string }> } | null };
